...
📧 Email: <a href="mailto:yadhugopakumar128@gmail.com" target="_blank" class="text-blue-400 underline">yadhugopakumar3@gmail.com</a>
...
🌐 Portfolio: <a href="https://portfolio-yadhugopakumar.netlify.app/" target="_blank" class="text-blue-400 underline">your-portfolio-link.com</a>
                ...
                {history.map((entry, idx) => (
                    <div key={idx}>
                        <div className="flex items-center space-x-2">
                            <p className="text-blue-400">gatere@portfolio:~$</p>
